...
namespace Raycoon.RayMigrator.Database.DataAccessLayers.MSSqlServer;

[DatabaseType("MSSqlServer")]
internal class DalMsSqlServer : DalBase, IDal
{
    private readonly string _connectionString;
    public override string DatabaseType { get; }
    public override DalSpecificProperties DalSpecificProperties { get; }

    public DalMsSqlServer(string connectionString)
    {
